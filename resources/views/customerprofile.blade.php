                            ...
                            <div class="col-lg-6">
                                ...
                                @foreach($data as $co)
                                    <tr> 
                                        ...
                                        <td class="social-user-name b-none p-t-0 text-muted">{{$co->Name}}</td>
                                    </tr>
                                    <tr>
                                        <th class="social-label b-none">Email</th>
                                        <td class="social-user-name b-none text-muted">{{$co->Email}}</td>
                                    </tr>
                                    <tr>
                                    <tr>
                                        <th class="social-label b-none">Gender</th>
                                        <td class="social-user-name b-none text-muted">{{$co->Gender}}</td>
                                    </tr>
                                    <tr>
                                        <th class="social-label b-none">Address</th>
                                        <td class="social-user-name b-none text-muted">{{$co->Address}}</td>
                                    </tr>
                                    <tr>
                                        <th class="social-label b-none">Country</th>
                                        <td class="social-user-name b-none text-muted">{{$co->Country}}</td>
                                    </tr>
                                    <tr>
                                        <th class="social-label b-none p-b-0">State</th>
                                        <td class="social-user-name b-none p-b-0 text-muted">{{$co->State}}</td>
                                    </tr>
                                    <tr>
                                        <th class="social-label b-none p-b-0">Date Of Birth</th>
                                        <td class="social-user-name b-none p-b-0 text-muted">{{$co->DOB}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>

                ...
                <div class="content-wrapper">
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Complaints History</h4>
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($data as $customercomplaint)
                                                <tr>
                                                    ...
                                                    <td>{{$customercomplaint->name}}</td>
                                                    <td>{{$customercomplaint->category}}</td>
                                                    <td>{{$customercomplaint->subcategory}}</td>
                                                    <td>{{$customercomplaint->complainttype}}</td>
                                                    <td>{{$customercomplaint->complaintdetails}}</td>
                                                    <td>{{$customercomplaint->status}}</td>
                                                    <td>
                                                        <a href="{{url('Approved',$customercomplaint->id)}}">
                                                            <div class="badge badge-outline-success">Approve

                                                            </div>
                                                        </a>
                                                        <a href="{{url('Canceled',$customercomplaint->id)}}">
                                                            <div class="badge badge-outline-danger">Cancel

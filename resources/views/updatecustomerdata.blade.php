        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="container" allign="center" style="padding: 100px">
                    ...
                    @endif
                    <form action="{{url('editcustomer', $value->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div style="padding: 15px;">
                            <label> Gender</label>
                            <input type="text" name="gender" value="{{$value->Gender}}">
                        </div>
                        <div style="padding: 15px;">
                            <label> Address</label>
                        ...
                        <div style="padding: 15px;">
                            ...
                            <input type="text" name="dob" value="{{$value->DOB}}">
                        </div>
                        <div style="padding: 15px;">

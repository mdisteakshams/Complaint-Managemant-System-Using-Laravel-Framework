  ...
  <div class="topbar">
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        ...
        <div class="collapse navbar-collapse col-lg-5" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              ...
              <a class="btn btn-primary ml-lg-3" href="{{url('/adminsignin')}}">Login As Admin</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-primary ml-lg-3" href="{{url('/signin')}}">Login As Customer</a>
            </li>
            <li class="nav-item">
      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="../assets/img/employees/Mine.jpg" alt="">
              <div class="meta">
            ...
            <div class="body">
              <p class="text-xl mb-0">Md.Isteak Shams</p>
              <span class="text-sm text-grey">Director of Admin</span>
            </div>
          </div>
        </div>
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="../assets/img/employees/employee1.jpg" alt="">
              <div class="meta">
                <a href="#"><span class="mai-call"></span></a>
                <a href="#"><span class="mai-logo-whatsapp"></span></a>
              </div>
            ...
            <div class="body">
              <p class="text-xl mb-0">Alen Johnson</p>
              <span class="text-sm text-grey">Director of IT</span>
            </div>
          </div>
        </div>
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Lisa Mary</p>
              <span class="text-sm text-grey">Backend Developer</span>
            </div>
          </div>
        </div>
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Evelyn Haynes</p>
              <span class="text-sm text-grey">Business Analyst</span>
            </div>
          </div>
        </div>
      </div>

        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Resetting Password </h3>
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('change_password/db') }}" class="md-float-material">
                        @csrf
                        <div class="col-lg-6">
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                ...
                                <input type="password" class="form-control form-control-lg @error('new_password') is-invalid @enderror" name="new_password" id="new_password">
                                <div class="form-control-icon">
                                    <i class="bi bi-shield-lock"></i>
                                </div>
                                @error('new_password')
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                ...
                                <input type="password" class="form-control form-control-lg" name="new_confirm_password" id="new_confirm_password">
                                <div class="form-control-icon">
                                    <i class="bi bi-shield-lock"></i>
                                </div>
